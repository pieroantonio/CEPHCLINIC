...
class PrevisioniBoxLayout(BoxLayout):
    ...
    def __init__(self, input_features, output_features, **kwargs):
        ...
        self.modello = {feature: carica_modello(f'modello_{feature}.joblib') for feature in output_features}
...
class PrevisioniApp(App):
    def build(self):
        input_features = ['Sex', 'Age', 'OB_FH', 'OJ_OC', 'U6L6D', 'LFHNP', 'IIANG', 'PLHNP', 'TFHNP']
        output_features = ['SNB', 'SNA', 'CONVX', 'SADLA', 'SNDST', 'COPOD', 'IMPA', 'COPAD', 'FMPA', 'WITSA', 'ANB', 'AB2FH', 'SNFHA', 'NP2PO', 'U1SNA', 'NP2PA']
